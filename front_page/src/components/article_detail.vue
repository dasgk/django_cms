...
<template id="article_main" style="background-color: white;width:60%;overflow-x: hidden;overflow-y: hidden;">
  ...
  <div>
    ...
    <div style="text-align: left;">
      ...
      <el-input style="width: 90%;margin-left: 5%;display: block;" type="textarea" :rows="5" placeholder="请输入您的高见">
      </el-input>
      <el-button type="success" style="display: block;margin-left:94%;margin-top:2%" icon="el-icon-chat-line-square"
                 plain></el-button>
    </div>
    <!----显示评论输入框结束 -->
